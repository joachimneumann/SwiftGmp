...
@MainActor @Test func basics1Test() {
    ...
    #expect(calculator.asString("2 * 4") == "8")
    #expect(calculator.asString("3 / 0") == "inf")
    #expect(calculator.asString("10/2") == "5")
    #expect(calculator.asString("-5.0 abs") == "5")
    #expect(calculator.asString("3.14 abs") == "3.14")
    #expect(calculator.asString("0.0 abs") == "0")
    #expect(calculator.asString("500 + 500") == "1000")
    #expect(calculator.asString("-100.25 abs") == "100.25")
    #expect(calculator.asString("12.5 abs") == "12.5")
    #expect(calculator.asString("153.4 - 153") == "0.4")
    #expect(calculator.asString("153.4 - 152") == "1.4")
    #expect(calculator.asString("153.4 - 142") == "11.4")
    ...
    #expect(calculator.asString("0.0 exp") == "1")
    temp = calculator.asDouble("-1.0 exp")
    ...
    #expect(temp.similarTo(0))
    #expect(calculator.asString("0.0 +/-") == "0")
    ...
    #expect(calculator.asString("90 sinD") == "1")
    #expect(calculator.asString("0 sinD") == "0")
    temp = calculator.asDouble("180 sinD")
    #expect(temp.similarTo(0))
    #expect(calculator.asString("270 sinD") == "-1")
    ...
    #expect(temp.similarTo(0))
    #expect(calculator.asString("45 tanD") == "1")
    temp = calculator.asDouble("60 tanD")
    #expect(temp.similarTo(1.7321))
    temp = calculator.asDouble("30 tanD")
    #expect(temp.similarTo(0.5774))
    #expect(calculator.asString("0 tanD") == "0")
    #expect(calculator.asString("0 asinD") == "0")
    #expect(calculator.asString("0 acosD") == "90")
    #expect(calculator.asString("0.5 asinD") == "30")
    #expect(calculator.asString("0.5 acosD") == "60")
    #expect(calculator.asString("1 atanD") == "45")
    #expect(calculator.asString("0 atanD") == "0")
    ...
    #expect(calculator.asString("1.0 acos") == "0")
    #expect(calculator.asString("0.0 sin") == "0")
