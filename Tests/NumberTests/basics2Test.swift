...
@MainActor @Test func basics2Test() {
    ...
    #expect(calculator.asString("-5 + 0") == "-5")
    #expect(calculator.asString("0 + 5") == "5")
    #expect(calculator.asString("-5 + 5") == "0")
    #expect(calculator.asString("300000000 + 900000000") == "1200000000")
    #expect(calculator.asString("900000000 + 900000000") == "1800000000")
    #expect(calculator.asString("999999999 + 1") == "1000000000")
    #expect(calculator.asString("-1987.50 + 1987") == "-0.5")
    #expect(calculator.asString("6 * 2 + 8") == "20")
    #expect(calculator.asString("1500 - 2000 + 0.25") == "-499.75")
    #expect(calculator.asString("1500 - 2000 + 1.23456789") == "-498.76543211")
    #expect(calculator.asString("1500 - 2000 + 123456789") == "123456289")
    #expect(calculator.asString("1500 - 2000") == "-500")
    #expect(calculator.asString("9 - 3") == "6")
    #expect(calculator.asString("-3 - 0") == "-3")
    #expect(calculator.asString("3 - 0") == "3")
    ...
    #expect(calculator.asString("50 + - 60") == "-10")
    #expect(calculator.asString("-5 + - 20") == "-25")
    #expect(calculator.asString("-1.33 - 2") == "-3.33")
    #expect(calculator.asString("123456789 - 210987654") == "-87530865")
    #expect(calculator.asString("7.12345678 - 2.21098765") == "4.91246913")
    #expect(calculator.asString("1500 * 2000") == "3000000")
    #expect(calculator.asString("6 * 2") == "12")
    ...
    #expect(calculator.asString("1500 * 0") == "0")
    #expect(calculator.asString("-1500 * 2000") == "-3000000")
    #expect(calculator.asString("-1.212 * 8") == "-9.696")
    ...
    #expect(calculator.asString("0 * 6 * 6") == "0")
    #expect(calculator.asString("1500 / 2000") == "0.75")
    #expect(calculator.asString("6 / 2") == "3")
    #expect(calculator.asString("0 / 2000") == "0")
    #expect(calculator.asString("-1500 / 2000") == "-0.75")
...
// 123456789 C = 0
    ...
    #expect(calculator.asString("0000") == "0")
    #expect(calculator.asString("000.11111") == "0.11111")
    #expect(calculator.asString("06") == "6")
    #expect(calculator.asString("6 * 06") == "36")
    ...
    #expect(calculator.asString("0123456789") == "123456789")
}
