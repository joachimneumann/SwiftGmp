...
for filename in glob.glob("*.txt"):
    ...
    print(basename+"TestR.swift")
    f = open(basename+"TestR.swift", 'w')
    ...
    writeln("")
    writeln("@Test func "+basename+"TestR() {")
    writeln("    let calculator = Calculator(precision: "+str(precision)+")")
    writeln("    var R = Representation()")
    writeln("    var RString: String")
    writeln("    let font = AppleFont.monospacedSystemFont(ofSize: 40, weight: .regular)")
    writeln("")
                ...
                if "=" in content:
                    ...
                    if len(components) == 2:
                        if components[0].strip() == "precision":
                            ...
                            writeln("    R = Representation(mantissaExponent: calculator.mantissaExponent!, proportionalFont: font, monoSpacedFont: font, decimalSeparator: DecimalSeparator.dot, separateGroups: true, ePadding: 0.0, width: 300)")
