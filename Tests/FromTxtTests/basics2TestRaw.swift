...
@Test func basics2TestRaw() {
    ...
    #expect(calculator.string == "2.60478582")

    calculator.evaluateString("123456789 * 210987654")
    #expect(calculator.string == "2.60478e16")
    ...
    #expect(calculator.string == "-1.6010246")

    calculator.evaluateString("4.21 / 3")
    #expect(calculator.string == "1.40333333")

    calculator.evaluateString("10 / 3.123")
    #expect(calculator.string == "3.20204931")

    calculator.evaluateString("0.234 / 3.123")
    #expect(calculator.string == "0.07492795")

    calculator.evaluateString("(1500 - 2000) / 3.12")
    #expect(calculator.string == "-160.25641")

    calculator.evaluateString("(1500 - 2000) / 312")
    #expect(calculator.string == "-1.6025641")

    calculator.evaluateString("(6 * 2) / 8")
    #expect(calculator.string == "1.5")

    calculator.evaluateString("1.23456789 / 2.10987654")
    #expect(calculator.string == "0.58513750")

    calculator.evaluateString("(1500 - 2000) / 1234.56789")
    #expect(calculator.string == "-0.4050000")

    calculator.evaluateString("(1500 - 2000) / 123456789")
    #expect(calculator.string == "-0.0000040")
