...
@Test func basics3Test() {
    ...
    #expect(calculator.double.similar(to: 3.1416))
    ...
    #expect(calculator.double.similar(to: 1.4142))
    calculator.evaluateString("zeta(3.0)")
    #expect(calculator.double.similar(to: 1.2021))
    calculator.evaluateString("ln(1.0)")
    #expect(calculator.string == "0")
    calculator.evaluateString("ln(2.0)")
    #expect(calculator.double.similar(to: 0.6931))
