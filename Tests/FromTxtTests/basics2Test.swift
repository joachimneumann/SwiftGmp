...
@Test func basics2Test() {
    ...
    #expect(calculator.string == "-7.7597485")
    calculator.evaluateString("4 powyx 3 + 12 / 9 sqrty 3")
    #expect(calculator.string == "86.7689982")
    ...
    #expect(calculator.string == "-498.76543")
    ...
    #expect(calculator.double.similar(to: 2.60478582))
    calculator.evaluateString("123456789 * 210987654")
    #expect(calculator.double.similar(to: 2.60478e16))
    calculator.evaluateString("-500 * 123456789")
    #expect(calculator.string == "-6.1728e10")
    calculator.evaluateString("-500 * 123.456789")
    #expect(calculator.string == "-61728.394")
