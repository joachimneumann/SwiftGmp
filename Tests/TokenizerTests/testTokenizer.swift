...
//        #expect(numbers[0].swiftGmp.toDouble() == 1)
...
//        #expect(numbers.count == 1)
//        #expect(numbers[0].swiftGmp.toDouble() == 3)
...
//        #expect(numbers[0].swiftGmp.toDouble() == 3)
//        #expect(numbers[1].swiftGmp.toDouble() == 4)
//        #expect(operators.count == 1)
...
//        #expect(numbers.count == 2)
//        #expect(numbers[0].swiftGmp.toDouble() == 3)
//        #expect(numbers[1].swiftGmp.toDouble() == 4e6)
//        #expect(operators.count == 1)
//        #expect(operators[0].isEqual(to: SwiftGmpTwoOperantOperation.sub))
//
...
//        #expect(numbers.count == 2)
//        #expect(numbers[0].swiftGmp.toDouble() == 3e-4)
//        #expect(numbers[1].swiftGmp.toDouble() == 4e-6)
//        #expect(operators.count == 1)
//        #expect(operators[0].isEqual(to: SwiftGmpTwoOperantOperation.sub))
//
